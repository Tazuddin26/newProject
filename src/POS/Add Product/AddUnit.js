    ...
    <div className="w-screen h-screen">
        <div className="w-full h-full bg-gray-100">
            ...
            <div className="w-[95%] h-[35%] bg-white first-letter:shadow-lg mt-8 ml-10 border border-gray-300 ">
                ...
                <div className="w-full h-[22%] border-b flex border-gray-300">
                    ...
                    <span className="ml-4 p-4 text-lg font-bold font-mono text-gray-700 ">Add Unit</span>
                </div>
                <div className="w-full h-full flex ">
                    <div className="w-[15%] h-full my-4 flex flex-col">
                        <span className="text-end ml-4 mb-4 mt-2  font-mono font-bold text-gray-700">Unit Name :</span>
