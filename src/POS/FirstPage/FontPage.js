...
function FontPage() {
  ...
  return (
    <div className="w-screen h-screen">
      ...
      >
        <div className="w-full h-full shadow-md fixed items-center  py-4 md:px-10 px-7 top-0 left-0">
          <div
          ...
          <div className="w-full h-[8%] p-2 flex justify-end">
            <ul
